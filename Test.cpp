...
{
    CHECK_THROWS(notebook.write(0,0,101,Direction::Vertical,"str"));
    CHECK_THROWS(notebook.read(0,0,102,Direction::Vertical,3));
    CHECK_THROWS(notebook.write(0,0,99,Direction::Vertical,"str"));
    CHECK_THROWS(notebook.read(0,0,99,Direction::Vertical,3));
    CHECK_THROWS(notebook.erase(0,0,80,Direction::Vertical,23));
